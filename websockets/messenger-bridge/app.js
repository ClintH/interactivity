...
function webSocketBroadcast(msg) {
  ...
  // Debug: show messages flowing through
...
function receivedMessage(event) {
  ...
  // Echo to connected clients
  webSocketBroadcast(messageString);
  ...
  if (messageText == 'mute') {
    ...
    sendTextMessage(senderID, 'Mute toggle');
    return;
  }
  ...
  if (messageText) {
    ...
    switch (messageText) {
      case 'image':
        sendImageMessage(senderID, 'https://picsum.photos/200/300/?random');
        break;
...
function sendImageMessage(recipientId, url) {
  if (typeof url == 'undefined') url = SERVER_URL + '/assets/rift.png';
  var messageData = {
    recipient: {
      id: recipientId
    },
