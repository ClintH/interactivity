...
function draw() {
  ...
  // Clear canvas by filling a large rectangle
  ctx.fillStyle = 'white';
...
function drawThing(tri, ctx) {
  ...
  const triCenter = getTriangleCenter(tri.x, tri.y, tri.size);

  // ...and angle between triangle and pointer
  let angle = getAngle(
    pointerX, pointerY,
